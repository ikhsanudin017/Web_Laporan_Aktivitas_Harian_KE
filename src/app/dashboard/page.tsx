...
export default function DashboardPage() {
  ...
  const exportMyReports = () => {
    ...
    const headerInfo = [
      ...
      [`📋 Nama: ${user?.name || ''}`],
      [`👤 Role: ${user?.role || ''}`],
      [`📊 Total Laporan: ${historyReports.length} laporan`],
    ...
    const excelData = historyReports.map((report, index) => {
      ...
      return {
        ...
        'Waktu Input ⏰': new Date(report.createdAt).toLocaleString('id-ID'),
        'Terakhir Update 🔄': new Date(report.updatedAt).toLocaleString('id-ID')
      }
    })
  ...
  return (
    <div className="min-h-screen bg-yellow-50">
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <Image 
                  ...
                  width={60} 
                  height={60}
                  className="rounded-full shadow-2xl border-2 border-yellow-300 relative z-10"
                />
              </div>
              <div>
                ...
                <p className="text-yellow-100 text-sm font-medium">مرحباً - Selamat datang, {user.name}</p>
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="btn-islamic-secondary flex items-center space-x-2"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
                <span>تصدير - Export Excel</span>
              </button>
              <button
                onClick={handleLogout}
                className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="border-b border-yellow-200 bg-white/50">
          <nav className="-mb-px flex space-x-8 px-6">
            ...
            >
              ...
              <span>إدخال التقرير - Input Laporan</span>
            </button>
            <button
            ...
            >
              ...
              <span>تاريخ التقارير - History Laporan ({historyReports.length})</span>
            </button>
          </nav>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-end">
                  <div className="flex-1">
                    <label htmlFor="date" className="block text-sm font-medium text-green-800 mb-2 flex items-center space-x-2">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                      </svg>
                      <span>تاريخ التقرير - Tanggal Laporan</span>
                    </label>
                    <input
                      type="date"
                      id="date"
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-yellow-500 text-gray-800 rounded-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 h-[42px]"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 h-[42px]"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="relative group">
                          <div className="relative">
                            <input
                              ...
                              min="1"
                              max="999"
                              className="mt-1 block w-full px-3 py-2 pr-12 border border-gray-300 rounded-lg shadow-sm 
                                       focus:outline-none focus:ring-2 focus:ring-ksu-yellow focus:border-ksu-orange 
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                              <div className="relative group-hover:scale-110 transition-transform duration-200">
                                <svg 
                                  className="w-5 h-5 text-ksu-orange group-hover:text-ksu-red transition-colors duration-200" 
                                  fill="none" 
                                  stroke="currentColor" 
                                  viewBox="0 0 24 24"
                                >
                          ...
                          <div className="mt-2 flex items-center justify-between text-xs transition-all duration-200">
                            <div className="flex items-center space-x-1 text-ksu-orange font-medium group-hover:text-ksu-red">
                              ...
                              <span>Klik untuk pilihan 1-30 atau ketik manual</span>
                            </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="btn-islamic-primary w-full flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
                      ...
                      <>
                        ...
                        <span>حفظ التقرير - Simpan Laporan</span>
                      </>
                    )}
                  </button>
                  <button
                    type="button"
                    onClick={resetForm}
                    className="bg-gray-500 text-white font-medium px-6 py-3 rounded-lg hover:bg-gray-600 hover:shadow-lg hover:scale-105 transition-all duration-200 border border-gray-600 flex items-center justify-center space-x-2"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clipRule="evenodd" />
                    </svg>
                    <span>إعادة تعيين - Reset Form</span>
                  </button>
                </div>
              </form>
            </div>
